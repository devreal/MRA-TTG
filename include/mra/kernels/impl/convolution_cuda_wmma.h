...
namespace mra {
  namespace accel {
      ...
      )
    {
      ...
      constexpr int ROWS_PER_WARP = K2 / mma::NumWarps;
      ...
      const int warp_id         = thread_id() / MRA_WARP_SIZE;
      const int warp_row_offset = warp_id * (K2 / mma::NumWarps);


      /**
       * Allocate shared memory for the result matrix to rotate.
       */
